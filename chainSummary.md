...
* 非对称加密：address & privatekey
  ...
  * ethereum地址生成过程
    ...
    ![key](https://github.com/wwchen8/MyBlockChainNotes/blob/master/Pic/key.png)
...
* 挖矿：区块交易打包过程
  * ethereum machanism 
    ...
    ![ethMine](https://github.com/wwchen8/MyBlockChainNotes/blob/master/Pic/TxMine.png)
...
* 共识算法：POW、POS、DPOS、PBFT
  ...
  * POW
    ...
    ![pow](https://github.com/wwchen8/MyBlockChainNotes/blob/master/Pic/pow-bitcoin.png)
  ...
  * POS
    ...
    ![pos](https://github.com/wwchen8/MyBlockChainNotes/blob/master/Pic/PoW.png)
  ...
  * DPOS
    ...
    ![DPOS](https://github.com/wwchen8/MyBlockChainNotes/blob/master/Pic/PoSvsDPoS.jpeg)
  ...
  * PBFT
    ...
    ![PBFT](https://github.com/wwchen8/MyBlockChainNotes/blob/master/Pic/PBFT.png)
## 2 ethereum & web3.js

* geth 为例，ethereum 结构
  * ethereum 结构
    
    ![ethStructure](https://github.com/wwchen8/MyBlockChainNotes/blob/master/Pic/EthStructure.png)
...
* solidity 编程
  ...
  * 1 编译&运行环境
    ...
    * 运行环境 : 以太坊虚拟机（**EVM**） 
      ...
      ![solidity](https://github.com/wwchen8/MyBlockChainNotes/blob/master/Pic/solidityV1.png)

  * 2 Solidity basic
    * 1 EVM ：bytecode的运行时环境 
  
      ![evm](https://github.com/wwchen8/MyBlockChainNotes/blob/master/Pic/EVM.png)
